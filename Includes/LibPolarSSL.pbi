; ########################################## Documentation ########################################
; 
; PolarSSL Library V1.000     Created 31.08.2012
; 
; Converted by David Vogel (Dadido3)
; 
; 
; ########################################## Constants ############################################
;- ################## Constants
...
CompilerIf #PB_Compiler_OS = #PB_OS_Windows
  CompilerIf #PB_Compiler_Processor = #PB_Processor_x86
    ImportC "../Librarys/libpolarssl.x86.lib" ; Windows x86
  CompilerElse
    ImportC "../Librarys/libpolarssl.x64.lib" ; Windows x64
  CompilerEndIf
CompilerElse
  CompilerIf #PB_Compiler_Processor = #PB_Processor_x86
    ImportC "../Librarys/libpolarssl.x86.a" ;     Linux x86
  CompilerElse
    ImportC "../Librarys/libpolarssl.x64.a" ;     Linux x64
  CompilerEndIf
CompilerEndIf
  ...
  ; * \return         0 If successful
  ; */
  aes_crypt_cfb128(*ctx.aes_context, mode.l, length.i, *iv_off, *iv, *input, *output)
  ...
  ; * \return         0 If successful, Or an POLARSSL_ERR_DHM_XXX error code
  ; */
  dhm_make_params(*ctx.dhm_context, x_size.l, *output, *olen.i, *f_rng.f_rng, *p_rng)
  ...
  ; */
  mpi_read_file(*X.mpi, radix.l, *fin.FILE)
  ...
  ; */
  mpi_write_file(*p, *X.mpi, radix.l, *fout.FILE)
  ...
  ; *                 POLARSSL_ERR_MPI_NEGATIVE_VALUE If b < 0
  ; */
  mpi_mod_int(*r.t_uint, *A.mpi, b.t_sint)
