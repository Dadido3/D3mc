...
MessageRequester("Old Include!", "Don't use that include (NBT.pbi) anymore, check your pb-root for the right one!")
...
Procedure NBT_Write_File(*NBT_Element.NBT_Element, Filename.s, GZip=#True)
  ...
  *Temp_Buffer = AllocateMemory(Temp_Buffer_Size)
  ...
  Real_Size = NBT_Write_Ram(*NBT_Element, *Temp_Buffer, Temp_Buffer_Size, GZip)
  If Not Real_Size
